...
<head>
    ...
    <!-- Title -->
    <title>Cenfarms - Farm Services &amp; Organic Food Store Template | Home</title>
    <!-- Favicon -->
...
<body>
                    ...
                    <div class="col-12">
                        <div class="top-header-content d-flex align-items-center justify-content-between">
                            ...
                            <div class="top-header-meta">
                                <p>Welcome to <span>Cenfarms</span>, we hope you will enjoy our products and have good experience on our farm blog</p>
                            </div>
                            <!-- Top Header Content -->
                            <div class="top-header-meta text-right">
                                <a href="#" data-toggle="tooltip" data-placement="bottom" title="infodeercreative@gmail.com"><i class="fa fa-envelope-o" aria-hidden="true"></i> <span>Email: cenfarms01@gmail.com</span></a>
                                <a href="#" data-toggle="tooltip" data-placement="bottom" title="+1 234 122 122"><i class="fa fa-phone" aria-hidden="true"></i> <span>Call Us: +234 806 838 3476 </span></a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="classy-menu">
                            ...
                            <div class="classynav">
                                <ul>
                                    ...
                                    <li><a href="farming-practice.html">Farming Practices</a></li>
    ...
    <div class="hero-area">
        <div class="welcome-slides owl-carousel">
                    ...
                    <div class="row h-100 align-items-center">
                        <div class="col-12 col-lg-10">
                            <div class="welcome-content">
                                ...
                                <p data-animation="fadeInUp" data-delay="400ms">Farmers hold the backbone of agricultural system. As it is common knowledge that for a country to progress the gross domestic product should be reasonable, agriculture is one of the important parts. The agricultural system
                                    will only run if there are crops being grown and harvested, so this where farmers come in.</p>
                                <a href="contact.html" class="btn famie-btn mt-4" data-animation="bounceInUp" data-delay="600ms">Contact Us</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row h-100 align-items-center">
                        <div class="col-12 col-lg-10">
                            <div class="welcome-content">
                                ...
                                <p data-animation="fadeInDown" data-delay="400ms">Farmers hold the backbone of agricultural system. As it is common knowledge that for a country to progress the gross domestic product should be reasonable, agriculture is one of the important parts. The agricultural system
                                    will only run if there are crops being grown and harvested, so this where farmers come in.</p>
                                <a href="contact.html" class="btn famie-btn mt-4" data-animation="bounceInDown" data-delay="600ms">Contact Us</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <!-- Single Welcome Slides -->
            <div class="single-welcome-slides bg-img bg-overlay jarallax" style="background-image: url(img/bg-img/07.jpg);">
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
                        <div class="col-12 col-lg-10">
                            <div class="welcome-content">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-12 col-md-8">
                    <div class="about-us-content mb-100">
                        ...
                        <p>CenFarms is an online farm website and blog that lets you know information and news regarding agriculture in general as well as giving you the platform to shop your farm products and also kind of agro-market place for farmers.
                            It is positioned to transform Sub-Saharan Africa into the hub that feeds the world by providing financial linkage between farm-investors and small holder farmers; and empowering passionate youths with the practical skills and
                            knowledge in building sustainable agribusinesses. The happiness that resonates among all stakeholders when they pull together is because 'Together everyone achieves more'. .
                        </p>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12 mb-50">
                        <p>CenFarms produces the best variety of cassava, tomatoes, and many vegetables. We are into egg and chicken production. Our varieties are specialized organic farm products. It is positioned to transform Sub-Saharan Africa into the
                            hub that feeds the world by providing financial linkage between farm-investors and small holder farmers; and empowering passionate youths with the practical skills and knowledge in building sustainable agribusinesses.</p>
                    </div>
                    ...
                    <div class="col-12 col-lg-6">
                        <div class="single-service-area mb-50 wow fadeInUp" data-wow-delay="100ms">
                            ...
                            <p>fruits and vegetables are classified depending on which part of the plant they come from. A fruit develops from the flower of a plant, while the other parts of the plant are categorized as vegetables. Some include melon, cucumber,
                                ugu, plantain, ukazi, garden egg, pineapple, waterleaf etc. </p>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-lg-6">
                        <div class="single-service-area mb-50 wow fadeInUp" data-wow-delay="300ms">
                            ...
                            <p>Our source of meat available is chicken and egg are produced in large scale from the finest and healthy set of layers. </p>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-lg-6">
                        <div class="single-service-area mb-50 wow fadeInUp" data-wow-delay="500ms">
                            <!-- Service Title -->
                            <div class="service-title mb-3 d-flex align-items-center">
                                <img src="img/core-img/cassava.png" alt="">
                                <h5>Cassava</h5>
                            </div>
                            <p>Cassava is a root vegetable, in CenFarms we have freshly harvested cassava. Cassava is drought tolerant, which means it also does reasonably well in poor soils with low rainfalls, hence, can be a reserve product in times of
                                farming. </p>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-lg-6">
                        <div class="single-service-area mb-50 wow fadeInUp" data-wow-delay="700ms">
                            ...
                            <p>At CenFarms we got fresh harvest corns and steady rice production for commercial quantity. This all year-round availability of this products is enabled by irrigation applied in the farms. </p>
                        </div>
                    </div>
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-lg-10">
                    <div class="newsletter-content">
                        ...
                        <p class="text-white mb-50 text-center">We produce the best quality of farm products and have best poultry that supplies all year-round eggs and chicken. You can shop at our website and read the recent news update on agriculture with farm blog feature added also.
                        </p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="testimonial-slides owl-carousel">
                        ...
                        <div class="single-slide">
                            ...
                            <div class="testi-text d-flex">
                                ...
                                <h5>"Thank you for your organic products. My children like your products and they use for breakfast. We are loving the pure milk, freshly fruit and of course our staple, Brown Rice Bread. Your Gluten Free breads truly make
                                    me feel lighter and uplifted. It's the only bread I plan to eat for the rest of my life. I will use them for many years."</h5>
                            </div>
